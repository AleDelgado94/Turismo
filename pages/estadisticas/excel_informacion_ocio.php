...
$excel->getProperties()->setTitle("Ocio");
...
$excel->getActiveSheet()->SetCellValue('A1', 'Ocio');
...
$excel->getActiveSheet()->SetCellValue('A6', 'Ocio');
...
header('Content-Disposition: attachment;filename="ocio.xlsx"');
