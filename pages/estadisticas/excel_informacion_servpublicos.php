...
$excel->getProperties()->setTitle("Servicios Públicos");
...
$excel->getActiveSheet()->SetCellValue('A1', 'Servicios Públicos');
...
$excel->getActiveSheet()->SetCellValue('A6', 'Servicios');
...
header('Content-Disposition: attachment;filename="servicios_publicos.xlsx"');
