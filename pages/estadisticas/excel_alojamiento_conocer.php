...
$excel->getProperties()->setTitle("Cómo conocieron el municipio");
...
$excel->getActiveSheet()->SetCellValue('A1', '¿Cómo conocieron el municipio?');
...
$excel->getActiveSheet()->SetCellValue('A6', 'Cómo conocieron');
...
header('Content-Disposition: attachment;filename="conocieron.xlsx"');
