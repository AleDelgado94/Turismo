...
$excel->getProperties()->setTitle("Motivo de visita");
...
$excel->getActiveSheet()->SetCellValue('A1', 'Motivo de visita');
...
$excel->getActiveSheet()->SetCellValue('A6', 'Motivo');
...
header('Content-Disposition: attachment;filename="motivo.xlsx"');
