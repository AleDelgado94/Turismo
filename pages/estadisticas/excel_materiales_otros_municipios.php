...
$excel->getProperties()->setTitle("Materiales Municipio");
...
$excel->getActiveSheet()->SetCellValue('A1', 'Materiales Otros Municipio');
...
$excel->getActiveSheet()->SetCellValue('A6', 'Materiales');
...
header('Content-Disposition: attachment;filename="materiales_otros_municipio.xlsx"');
