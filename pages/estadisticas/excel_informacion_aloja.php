...
$excel->getProperties()->setTitle("Alojamiento");
...
$excel->getActiveSheet()->SetCellValue('A1', 'Alojamiento');
...
$excel->getActiveSheet()->SetCellValue('A6', 'Recursos');
...
header('Content-Disposition: attachment;filename="alojamiento.xlsx"');
