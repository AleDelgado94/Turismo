...
$excel->getProperties()->setTitle("Materiales Otras Islas");
...
$excel->getActiveSheet()->SetCellValue('A1', 'Materiales Otras Islas');
...
header('Content-Disposition: attachment;filename="materiales_otras_islas.xlsx"');
