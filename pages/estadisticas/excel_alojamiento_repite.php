...
$excel->getProperties()->setTitle("Repite visita");
...
$excel->getActiveSheet()->SetCellValue('A1', '¿Repite Visita?');
...
$excel->getActiveSheet()->SetCellValue('A6', 'Repite');
...
header('Content-Disposition: attachment;filename="repite.xlsx"');
