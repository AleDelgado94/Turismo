...
$excel->getProperties()->setTitle("Se aloja en el municipio");
...
$excel->getActiveSheet()->SetCellValue('A1', '¿Se aloja?');
...
$excel->getActiveSheet()->SetCellValue('A6', 'Aloja');
...
header('Content-Disposition: attachment;filename="se_aloja.xlsx"');
