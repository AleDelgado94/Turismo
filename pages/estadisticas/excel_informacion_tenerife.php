...
$excel->getProperties()->setTitle("Información Tenerife");
...
$excel->getActiveSheet()->SetCellValue('A1', 'Información Tenerife');
...
$excel->getActiveSheet()->SetCellValue('A6', 'Info');
...
header('Content-Disposition: attachment;filename="info_tenerife.xlsx"');
