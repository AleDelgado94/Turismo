...
$excel->getProperties()->setTitle("Materiales Tenerife");
...
$excel->getActiveSheet()->SetCellValue('A1', 'Materiales Tenerife');
...
header('Content-Disposition: attachment;filename="materiales_tenerife.xlsx"');
