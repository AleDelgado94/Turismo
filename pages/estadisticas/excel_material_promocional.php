...
$excel->getProperties()->setTitle("Material Promocional");
...
$excel->getActiveSheet()->SetCellValue('A1', 'Material Promocional');
...
header('Content-Disposition: attachment;filename="materiales_promocional.xlsx"');
